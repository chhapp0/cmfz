...
public class ServerMonitorDaemonTest {
    ...
    public void testUnavailableServer() throws Exception {
        Server server = new Server("192.168.239.132", 8889, new SocketConfig(1000));
    ...
    public void testAvailableServer() throws Exception {
        Server server = new Server("192.168.239.132", 8888, new SocketConfig(1000));
        long start = System.currentTimeMillis();
    ...
    public void testMonitoring() throws Exception {
        Server server8888 = new Server("192.168.239.132", 8888);
        Server server8889 = new Server("192.168.239.132", 8888);
        Server server8890 = new Server("192.168.239.132", 8888);
