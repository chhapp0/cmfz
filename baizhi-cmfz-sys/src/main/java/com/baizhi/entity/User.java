...
public class User {
   ...
   /* public String getId() {
    ...
    public User(String id, String nickname, String farmington, String gender, String description, String phone, String salt, String pwd, String photo, Guru guru, Province province, City city, List<Work> work, Role role) {
        this.id = id;
        this.nickname = nickname;
        this.farmington = farmington;
        this.gender = gender;
